...
# this  is the up date version for in put with image pair 3
...
netD = ShiftingNetBody.ShiftingNet_init2( None)
...
while(1):
    ...
    while(1):
        ...
        if read_id % 2 == 0:
            ...
            show7 = numpy.append(show4,show5,axis=1) # cascade
            show7 = numpy.append(show7,show6,axis=1) # cascade
            show7  = show7 +104 
            cv2.imshow('Input one',show7.astype(numpy.uint8)) 
