...
class _ShiftingNet(nn.Module):
    ...
    def __init__(self,batchNorm=True):
        ...
        self.deconv3 = deconv(512,512)
        self.deconv2 = deconv(1024,256)
        ...
        self.predict_shift4 = predict_shift(512)
        self.predict_shift3 = predict_shift(1024)
        self.predict_shift2 = predict_shift(512)
    ...
    def forward(self, x):
        out_conv2 = self.conv1(x)
        out_conv3 =  self.conv2(out_conv2)
        out_conv4 = self.conv3(  out_conv3)
        ...
        shift4       = self.predict_shift4(out_conv4)
        #shift6_up    = crop_like(self.upsampled_shift6_to_5(shift6), out_conv5)
        ...
        if self.training:
            return shift2,shift2,shift3,shift3,shift4
        else:
            return shift2
